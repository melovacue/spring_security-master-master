...
@Configuration
@PropertySource("class:db.properties")
...
public class HibernateConfig {
    ...
    Properties additionalProperties() {
        ...
        properties.put("hibernate.strategy", env.getProperty("db.strategy"));
        properties.put("hibernate.naming.physical.strategy", env.getProperty(("db.physical-strategy")));
